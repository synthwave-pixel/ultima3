...
frames. The redraw was briefed in `snake-brief.md` and is in the sheet. Pincher, Snatch
and Griffon were redrawn in a second pass (`second-pass-brief.md`) and are in
the sheet.
